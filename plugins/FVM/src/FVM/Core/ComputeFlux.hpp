...
#ifndef CF_FVM_Core_ComputeFlux_hpp
#define CF_FVM_Core_ComputeFlux_hpp
...
class FVM_Core_API ComputeFlux : public Solver::Actions::CLoopOperation
{
public: // typedefs
...
#endif // CF_FVM_CoreComputeFlux_hpp
