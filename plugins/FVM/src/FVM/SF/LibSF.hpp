...
#ifndef CF_FVM_SF_LibSF_hpp
#define CF_FVM_SF_LibSF_hpp
...
/// Define the macro FVM_SF_API
/// @note build system defines COOLFLUID_RDM_EXPORTS when compiling FVM files
#ifdef COOLFLUID_FVM_SF_EXPORTS
#   define FVM_SF_API      CF_EXPORT_API
#   define FVM_SF_TEMPLATE
#else
#   define FVM_SF_API      CF_IMPORT_API
#   define FVM_SF_TEMPLATE CF_TEMPLATE_EXTERN
#endif
...
public: // functions
  ...
  static std::string library_namespace() { return "CF.FVM.SF"; }
