...
#ifndef CF_FVM_ComputeFluxCons2D_hpp
#define CF_FVM_ComputeFluxCons2D_hpp
...
class FVM_API ComputeFluxCons2D : public Solver::Actions::CLoopOperation
{
public: // typedefs

  /// pointers
  typedef boost::shared_ptr<ComputeFluxCons2D> Ptr;
  typedef boost::shared_ptr<ComputeFluxCons2D const> ConstPtr;

public: // functions
  /// Contructor
  /// @param name of the component
  ComputeFluxCons2D ( const std::string& name );

  /// Virtual destructor
  virtual ~ComputeFluxCons2D() {};

  /// Get the class name
  static std::string type_name () { return "ComputeFluxCons2D"; }
...
private: // data
  ...
  boost::shared_ptr<RoeFluxSplitterCons2D> m_fluxsplitter;
};
...
#endif // CF_FVM_ComputeFluxCons2D_hpp
