...
#ifndef cf3_sdm_navierstokes_BCWallEuler3D_hpp
#define cf3_sdm_navierstokes_BCWallEuler3D_hpp
...
class sdm_navierstokes_API BCWallEuler3D : public BCWeak< PhysDataBase<5u,3u> >
{
private:
  enum {Rho=0, RhoUx=1, RhoUy=2, RhoUz=3, RhoE=4};
public:
  static std::string type_name() { return "BCWallEuler3D"; }
  BCWallEuler3D(const std::string& name) : BCWeak< PhysData >(name)
  {
  }
  virtual ~BCWallEuler3D() {}
  ...
  virtual void compute_solution(const PhysData& inner_cell_data, const RealVectorNDIM& unit_normal, RealVectorNEQS& boundary_face_pt_data)
  {
    ...
    rhoU[ZZ] = inner_cell_data.solution[RhoUz];
    ...
    boundary_face_pt_data[RhoUz]=rhoU[ZZ];
...
#endif // cf3_sdm_BCWallEuler3D_hpp
