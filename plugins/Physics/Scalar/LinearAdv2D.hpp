...
#ifndef cf3_physics_Scalar_LinearAdv2D_hpp
#define cf3_physics_Scalar_LinearAdv2D_hpp
...
class Scalar_API LinearAdv2D : public VariablesT<LinearAdv2D> {
...
public: //typedefs
  ...
  typedef boost::shared_ptr<LinearAdv2D> Ptr;
  typedef boost::shared_ptr<LinearAdv2D const> ConstPtr;

public: // functions

  /// constructor
  /// @param name of the component
  LinearAdv2D ( const std::string& name );
  ...
  static void flux( const MODEL::Properties& p,
                    ...
                    FM& flux)
  {
    flux[0] = p.u * (p.v[XX] * direction[XX] + p.v[YY] * direction[YY]);
  }
...
#endif // cf3_physics_Scalar_LinearAdv2D_hpp
