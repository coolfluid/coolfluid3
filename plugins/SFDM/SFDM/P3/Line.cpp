...
{
  const static boost::shared_ptr< SFDM::ShapeFunction > line_sf(common::allocate_component< P3::Line >(P3::Line::type_name()));
  return *line_sf;
}
...
{
  const static boost::shared_ptr< SFDM::ShapeFunction > flux_line_sf(common::allocate_component< P4::Line >(P4::Line::type_name()));
  return *flux_line_sf;
}
