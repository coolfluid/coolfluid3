...
#ifndef CF_SFDM_SF_LineSolutionP2_hpp
#define CF_SFDM_SF_LineSolutionP2_hpp
...
class SFDM_SF_API LineSolutionP2  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  LineSolutionP2(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "LineSolutionP2"; }
...
#endif // CF_SFDM_SF_LineSolutionP2
