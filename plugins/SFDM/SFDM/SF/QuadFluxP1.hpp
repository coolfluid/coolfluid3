...
#ifndef CF_SFDM_SF_QuadFluxP1_hpp
#define CF_SFDM_SF_QuadFluxP1_hpp
...
class SFDM_SF_API QuadFluxP1  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  QuadFluxP1(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "QuadFluxP1"; }
  ...
  static const LineFluxP1& line_type();
