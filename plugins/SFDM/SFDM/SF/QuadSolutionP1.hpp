...
#ifndef CF_SFDM_SF_QuadSolutionP1_hpp
#define CF_SFDM_SF_QuadSolutionP1_hpp
...
namespace SFDM {
namespace SF {
  class LineSolutionP1;

class SFDM_SF_API QuadSolutionP1  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  QuadSolutionP1(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "QuadSolutionP1"; }
  ...
  static const LineSolutionP1& line_type();
...
#endif // CF_SFDM_SF_QuadSolutionP1
