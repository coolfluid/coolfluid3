...
{
  const static boost::shared_ptr< ShapeFunction > line_sf(common::allocate_component< P1::Line >(P1::Line::type_name()));
  return *line_sf;
}
...
{
  const static boost::shared_ptr< ShapeFunction > flux_line_sf(common::allocate_component< P2::Line >(P2::Line::type_name()));
  return *flux_line_sf;
}
