...
#ifndef CF_SFDM_SF_QuadSolutionP2_hpp
#define CF_SFDM_SF_QuadSolutionP2_hpp
...
namespace SFDM {
namespace SF {
  class LineSolutionP2;

class SFDM_SF_API QuadSolutionP2  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  QuadSolutionP2(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "QuadSolutionP2"; }
...
#endif // CF_SFDM_SF_QuadSolutionP2
