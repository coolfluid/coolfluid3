...
#ifndef CF_SFDM_SF_LineSolutionP0_hpp
#define CF_SFDM_SF_LineSolutionP0_hpp
...
class SFDM_SF_API LineSolutionP0  : public Core::ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  LineSolutionP0(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "LineSolutionP0"; }
...
#endif // CF_SFDM_SF_LineSolutionP0
