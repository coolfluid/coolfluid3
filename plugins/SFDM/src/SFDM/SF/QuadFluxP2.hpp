...
#ifndef CF_SFDM_SF_QuadFluxP2_hpp
#define CF_SFDM_SF_QuadFluxP2_hpp
...
class SFDM_SF_API QuadFluxP2  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  QuadFluxP2(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "QuadFluxP2"; }
  ...
  static const LineFluxP2& line_type();
