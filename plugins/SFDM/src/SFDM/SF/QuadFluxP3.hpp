...
#ifndef CF_SFDM_SF_QuadFluxP3_hpp
#define CF_SFDM_SF_QuadFluxP3_hpp
...
class SFDM_SF_API QuadFluxP3  : public ShapeFunction {
public:

  static const Uint dimensionality = 2;
  static const Uint nb_nodes = 20;
  static const Uint order = 3;
  static const Mesh::GeoShape::Type shape = Mesh::GeoShape::QUAD;

  static const Uint nb_orientations = 2;
  static const Uint nb_lines_per_orientation = 3;
  static const Uint nb_nodes_per_line = 4;
...
public:
  ...
  /// Constructor
  QuadFluxP3(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "QuadFluxP3"; }
  ...
  static const LineFluxP3& line_type();
