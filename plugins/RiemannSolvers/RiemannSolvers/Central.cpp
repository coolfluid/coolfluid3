...
{
  option("physical_model").attach_trigger( boost::bind( &Central::trigger_physical_model, this) );
}
...
void Central::compute_interface_flux(const RealVector& left, const RealVector& right, const RealVector& normal,
                                     RealVector& flux)
{
...
void Central::compute_interface_flux_and_wavespeeds(const RealVector& left, const RealVector& right, const RealVector& normal,
