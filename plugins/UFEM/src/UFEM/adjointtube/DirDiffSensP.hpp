...
#ifndef cf3_UFEM_DirDiffSensP_hpp
#define cf3_UFEM_DirDiffSensP_hpp
...
class UFEM_API DirDiffSensP : public solver::actions::Proto::ProtoAction
{
public:

  /// Contructor
  /// @param name of the component
  DirDiffSensP ( const std::string& name );

  virtual ~DirDiffSensP();

  /// Get the class name
  static std::string type_name () { return "DirDiffSensP"; }
