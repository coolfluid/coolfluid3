...
#ifndef cf3_UFEM_LibUFEMParticles_hpp
#define cf3_UFEM_LibUFEMParticles_hpp
...
class UFEM_API LibUFEMParticles :
    public common::Library
{
public:

  /// Constructor
  LibUFEMParticles ( const std::string& name) : common::Library(name) {   }

public: // functions

  /// @return string of the library namespace
  static std::string library_namespace() { return "cf3.UFEM.particles"; }

  /// Static function that returns the library name.
  /// Must be implemented for Library registration
  /// @return name of the library
  static std::string library_name() { return "particles"; }
  ...
  /// Gets the Class name
  static std::string type_name() { return "LibUFEMParticles"; }

}; // end LibUFEMParticles
...
#endif // cf3_UFEM_LibUFEMParticles_hpp
