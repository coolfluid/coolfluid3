...
#ifndef cf3_UFEM_NavierStokesExplicitVelocity_hpp
#define cf3_UFEM_NavierStokesExplicitVelocity_hpp
...
class UFEM_API NavierStokesExplicitVelocity : public LSSActionUnsteady
{
public: // functions

  /// Contructor
  /// @param name of the component
  NavierStokesExplicitVelocity ( const std::string& name );

  virtual ~NavierStokesExplicitVelocity();

  /// Get the class name
  static std::string type_name () { return "NavierStokesExplicitVelocity"; }
...
#endif // cf3_UFEM_NavierStokesExplicitVelocity_hpp
