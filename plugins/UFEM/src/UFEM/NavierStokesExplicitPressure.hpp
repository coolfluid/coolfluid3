...
#ifndef cf3_UFEM_NavierStokesExplicitPressure_hpp
#define cf3_UFEM_NavierStokesExplicitPressure_hpp
...
class UFEM_API NavierStokesExplicitPressure : public LSSActionUnsteady
{
public: // functions

  /// Contructor
  /// @param name of the component
  NavierStokesExplicitPressure ( const std::string& name );

  virtual ~NavierStokesExplicitPressure();

  /// Get the class name
  static std::string type_name () { return "NavierStokesExplicitPressure"; }
...
#endif // cf3_UFEM_NavierStokesExplicitPressure_hpp
