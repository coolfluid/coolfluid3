...
void EersteStap::trigger_setup()
{
  ...
  FieldVariable<6, ScalarField> J("SensDer", "sensitivity_derivative");//, mesh::LagrangeP0::LibLagrangeP0::library_namespace());
  FieldVariable<7, VectorField> grad_Uy("grad_Uy", "Adjvelocity_gradient");
  FieldVariable<8, ScalarField> nu("KinematicViscosity", "kinematic_viscosity");
