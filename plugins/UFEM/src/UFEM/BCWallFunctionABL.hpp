...
#ifndef cf3_UFEM_BCWallFunctionABL_hpp
#define cf3_UFEM_BCWallFunctionABL_hpp
...
class UFEM_API BCWallFunctionABL : public solver::Action
{
public:

  /// Contructor
  /// @param name of the component
  BCWallFunctionABL ( const std::string& name );

  virtual ~BCWallFunctionABL();

  /// Get the class name
  static std::string type_name () { return "BCWallFunctionABL"; }
