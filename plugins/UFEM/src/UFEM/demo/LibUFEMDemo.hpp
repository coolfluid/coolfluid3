...
#ifndef cf3_UFEM_LibUFEMDemo_hpp
#define cf3_UFEM_LibUFEMDemo_hpp
...
class UFEM_API LibUFEMDemo :
    public common::Library
{
public:

  /// Constructor
  LibUFEMDemo ( const std::string& name) : common::Library(name) {   }

public: // functions

  /// @return string of the library namespace
  static std::string library_namespace() { return "cf3.UFEM.demo"; }

  /// Static function that returns the library name.
  /// Must be implemented for Library registration
  /// @return name of the library
  static std::string library_name() { return "demo"; }
  ...
  /// Gets the Class name
  static std::string type_name() { return "LibUFEMDemo"; }
...
#endif // cf3_UFEM_LibUFEMDemo_hpp
