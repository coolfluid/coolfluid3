...
#ifndef cf3_UFEM_EersteStap_hpp
#define cf3_UFEM_EersteStap_hpp
...
class UFEM_API EersteStap : public solver::ActionDirector
{
public:

  /// Contructor
  /// @param name of the component
  EersteStap ( const std::string& name );

  virtual ~EersteStap();

  /// Get the class name
  static std::string type_name () { return "EersteStap"; }
