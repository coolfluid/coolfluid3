...
#ifndef cf3_UFEM_KineticEnergyIntegral_hpp
#define cf3_UFEM_KineticEnergyIntegral_hpp
...
class UFEM_API KineticEnergyIntegral : public solver::actions::Proto::ProtoAction
{
public:
  /// Contructor
  /// @param name of the component
  KineticEnergyIntegral ( const std::string& name );
  
  virtual ~KineticEnergyIntegral();

  /// Get the class name
  static std::string type_name () { return "KineticEnergyIntegral"; }
...
#endif // cf3_UFEM_KineticEnergyIntegral_hpp
