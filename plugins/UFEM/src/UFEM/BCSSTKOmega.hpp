...
#ifndef cf3_UFEM_BCWallFunctionSST_hpp
#define cf3_UFEM_BCWallFunctionSST_hpp
...
class UFEM_API BCWallFunctionSST : public solver::actions::Proto::ProtoAction
{
public:

  /// Contructor
  /// @param name of the component
  BCWallFunctionSST ( const std::string& name );

  virtual ~BCWallFunctionSST();

  /// Get the class name
  static std::string type_name () { return "BCWallFunctionSST"; }
...
#endif // cf3_UFEM_BCWallFunctionSST_hpp
