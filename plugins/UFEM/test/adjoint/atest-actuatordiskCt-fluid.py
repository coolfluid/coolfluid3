...
disk1 = solver.add_unsteady_solver('cf3.UFEM.adjoint.ActuatorDiskCt')
disk1.area = area
disk1.u_in = u_in[0]
disk1.th = thickness
disk1.ct = Ct1
...
disk2 = solver.add_unsteady_solver('cf3.UFEM.adjoint.ActuatorDiskCt')
disk2.area = area
disk2.u_in = u_in[0]
disk2.th = thickness
disk2.ct = Ct2
...
disk1.regions = [mesh.topology.actuator1.uri()]
disk2.regions = [mesh.topology.actuator2.uri()]
