...
bca.add_constant_bc(region_name = 'outlet', variable_name = 'ka').value = 0.
bca.add_constant_bc(region_name = 'outlet', variable_name = 'epsilona').value = 0.
bca.add_constant_bc(region_name = 'top', variable_name = 'ka').value = 0.
bca.add_constant_bc(region_name = 'top', variable_name = 'epsilona').value = 0.
bca.add_constant_bc(region_name = 'bottom', variable_name = 'ka').value = 0.
bca.add_constant_bc(region_name = 'bottom', variable_name = 'epsilona').value = 0.
