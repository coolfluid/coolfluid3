...
n = 100
#matrix_builder = 'cf3.math.LSS.TrilinosCrsMatrix'
matrix_builder = 'cf3.math.LSS.EmptyLSSMatrix'
...
ns_solver.children.AuxiliaryLSS.matrix_builder = matrix_builder
ns_solver.children.PressureLSS.matrix_builder = matrix_builder
ns_solver.children.CorrectionLSS.matrix_builder = matrix_builder
...
ns_solver.children.AuxiliaryLSS.options.disabled_actions = ['SolveLSS']
ns_solver.children.PressureLSS.options.disabled_actions = ['SolveLSS']
ns_solver.children.CorrectionLSS.options.disabled_actions = ['SolveLSS']
...
for i in range(9):
  ns_solver.children.AuxiliaryLSS.children.MatrixAssembly.execute()
  ns_solver.children.AuxiliaryLSS.children.RHSAssembly.execute()
  ns_solver.children.PressureLSS.children.MatrixAssembly.execute()
  ns_solver.children.PressureLSS.children.RHSAssembly.execute()
  ns_solver.children.CorrectionLSS.children.MatrixAssembly.execute()
  ns_solver.children.CorrectionLSS.children.RHSAssembly.execute()
