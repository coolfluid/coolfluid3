...
# lss setup
lss_p = ns_solver.InnerLoop.PressureSystem.create_lss('cf3.math.LSS.TrilinosCrsMatrix')
lss_p.Matrix.settings_file = sys.argv[1]

lss_u = ns_solver.InnerLoop.VelocitySystem.create_lss('cf3.math.LSS.TrilinosCrsMatrix')
lss_u.Matrix.settings_file = sys.argv[1]
...
bc_u.create_bc_action(region_name = 'bottom', builder_name = 'cf3.UFEM.NavierStokesSemiExplicitVelocityBC').value = ['0.', '0.']
bc_u.create_bc_action(region_name = 'top', builder_name = 'cf3.UFEM.NavierStokesSemiExplicitVelocityBC').value = ['0.', '0.']
bc_u.create_bc_action(region_name = 'left', builder_name = 'cf3.UFEM.NavierStokesSemiExplicitVelocityBC').value = ic_u.value
