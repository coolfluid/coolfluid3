...
eq_euler = solver.add_unsteady_solver('cf3.UFEM.VelocityGradient')
eq_euler.options.velocity_tag = 'navier_stokes_solution'
...
writer.file = cf.URI('equilibrium-euler-{iteration}.pvtu')
writer.mesh = mesh
series_writer.interval = write_interval

solver.create_fields()
writer.fields = [mesh.geometry.navier_stokes_solution.uri(), mesh.geometry.velocity_gradient.uri(), mesh.geometry.node_valence.uri()]
