...
solver.options().set('update_vars', 'LinearAdv3D')
...
iconds.get_child('INIT').options().set('functions',['sin(x*y*z)'])
...
bcs.get_child('INLET').options().set('functions', ['cos(2*3.141592*(x+y+z))'])
