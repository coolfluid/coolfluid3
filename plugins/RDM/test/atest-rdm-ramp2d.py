...
solver.get_child('IterativeSolver').get_child('Update').get_child('Step').options().configure_option('cfl', 0.2)

### initial conditions

iconds = solver.get_child('InitialConditions')
iconds.create_initial_condition(name='INIT')
iconds.get_child('INIT').options().configure_option('functions',['0.5','1.67332','0.0','3.425'])
...
bcs.get_child('INLET').options().configure_option('functions', ['0.5','1.67332','0.0','3.425'])
