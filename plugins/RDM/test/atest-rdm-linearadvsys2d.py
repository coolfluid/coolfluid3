...
solver.options().configure_option('update_vars', 'LinearAdvSys2D')
...
iconds.get_child('INIT').options().configure_option('functions',['x*x+y*y','0'])
...
bcs.get_child('INLET').options().configure_option('functions', ['2.0*cos(2*3.141592*(x+y))','3.0*cos(2*3.141592*(x+y))'])
