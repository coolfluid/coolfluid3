...
BOOST_AUTO_TEST_SUITE( Burgers_steady_Suite )
...
//  files.push_back( "file:square1x1-tg-p1.msh" );
  ...
  //files.push_back( "file:square1x1-qd-p2.msh" );
//  files.push_back( "file:square1x1-qd-p1.msh" );
...
//  CFinfo << Core::instance().root()->tree() << CFendl;
  ...
  boost::filesystem::path file ("sol.msh");
