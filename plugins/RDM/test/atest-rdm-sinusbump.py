...
solver.get_child('IterativeSolver').get_child('MaxIterations').options().set('maxiter', 10)
solver.get_child('IterativeSolver').get_child('Update').get_child('Step').options().set('cfl', 0.01)

### initial conditions

iconds = solver.get_child('InitialConditions')
iconds.create_initial_condition(name='INIT')
iconds.get_child('INIT').options().set('functions', ['1.204751547','206.7002847','0.0','271044.375'])
...
bcs.get_child('INLET').options().set('rho_in', '1.204751547')
bcs.get_child('INLET').options().set('vel_in', ['171.570881','0.'])
...
#])
#bcs.get_child('OUTLET').options().set('p_out', ['101325.0'])
