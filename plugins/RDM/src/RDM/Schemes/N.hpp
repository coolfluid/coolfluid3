...
#ifndef CF_RDM_Schemes_N_hpp
#define CF_RDM_Schemes_N_hpp
...
class RDM_SCHEMES_API N : public RDM::CellTerm {
...
public: // typedefs
  ...
  typedef boost::shared_ptr< N > Ptr;
  typedef boost::shared_ptr< N const > ConstPtr;
...
public: // functions
  ...
  N ( const std::string& name );

  /// Virtual destructor
  virtual ~N();

  /// Get the class name
  static std::string type_name () { return "N"; }
...
class RDM_SCHEMES_API N::Term : public SchemeBase<SF,QD,PHYS> {
...
public: // functions
  ...
  /// Get the class name
  static std::string type_name () { return "N.Term<" + SF::type_name() + "," + PHYS::type_name() + ">"; }
...
template<typename SF,typename QD, typename PHYS>
void N::Term<SF,QD,PHYS>::execute()
{
