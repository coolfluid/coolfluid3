...
"    {                                                                                                      \n"
"     for( uint tx = get_group_id(0); tx < elem; tx+= get_num_groups(0) )                                        \n"
"     {                                                                                                     \n"
...
"                                                                                                                                                                      \n"
"               Lv[adressQ]    = 1.0-coeffM2;                  Lv[adressQ+1]  = uDivA / a;        Lv[adressQ+2]  = vDivA / a;        Lv[adressQ+3] = -(gamma-1)/(a*a);  \n"
...
"                                                                                                                                                    \n"
"               Dv[j*nEq] = max(um,0.0); Dv[j*nEq+1] = max(um,0.0); Dv[j*nEq+2] = max(um+a,0.0); Dv[j*nEq+3] =max(um-a,0.0);                         \n"
"                                                                                                                                                    \n"
"                                                                                                                                                    \n"
"                                                                                                                                                    \n"
...
"                                                                                                                                                    \n"
"               float wave_speed = max( max(Dv[j*nEq], Dv[j*nEq+1]), max( Dv[j*nEq+2], Dv[j*nEq+3] ) ) * weights[j] *jq[j];                          \n"
...
"           }                                                                                                  \n"
"        }                                                                                                     \n"
"        for(unsigned int j = get_local_id(0);j< nEq;j+= get_local_size(0) )                                   \n"
"        {                                                                                                     \n"
"            float sumPhi = 0; float sumPhiN = 0;                                                              \n"
"            for(unsigned int k = 0;k< shape;k++ )                                                             \n"
"            {                                                                                                 \n"
"                sumPhi  += phiH[k*nEq];                                                                       \n"
"                sumPhiN += fabs(phiH[k*nEq]+phiHN[k*nEq]);                                                    \n"
"            }                                                                                                 \n"
"            float theta=0.0;                                                                                  \n"
"            if( sumPhiN != 0 )                                                                                \n"
"              theta = fabs(sumPhi) / sumPhiN;                                                                 \n"
"                                                                                                              \n"
"            for(unsigned int k = 0;k< shape;k++ )                                                             \n"
"            {                                                                                                 \n"
