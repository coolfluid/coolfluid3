...
namespace viennacl
{
  namespace linalg
  {
    ...
    */
    ...
    VectorType solveGPGPU(const MatrixType & matrix, VectorType const & rhs, cg_tag const & tag)
    {
    ...
    template <typename MatrixType, typename VectorType>
    VectorType solveGPGPU(const MatrixType & matrix, VectorType const & rhs, cg_tag const & tag, viennacl::linalg::no_precond)
    {
    ...
    */
    ...
    VectorType solveGPGPU(const MatrixType & matrix, VectorType const & rhs, cg_tag const & tag, PreconditionerType const & precond)
    {
      typedef typename VectorType::value_type      ScalarType;
