...
#ifndef cf3_mesh_SpaceInterpolator_hpp
#define cf3_mesh_SpaceInterpolator_hpp
...
class Mesh_API SpaceInterpolator : public AInterpolator {

public: // functions

  /// Contructor
  /// @param name of the component
  SpaceInterpolator ( const std::string& name );

  /// Virtual destructor
  virtual ~SpaceInterpolator() {}

  /// Get the class name
  static std::string type_name () { return "SpaceInterpolator"; }
...
#endif // cf3_mesh_SpaceInterpolator_hpp
