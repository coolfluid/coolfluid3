...
#include "mesh/LagrangeP2/Point.hpp"
...
common::ComponentBuilder < ShapeFunctionT<Point>, ShapeFunction, LibLagrangeP2 >
   Point_Builder(LibLagrangeP2::library_namespace()+"."+Point::type_name());
