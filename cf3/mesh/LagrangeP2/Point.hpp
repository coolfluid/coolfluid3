...
#ifndef cf3_mesh_LagrangeP2_Point_hpp
#define cf3_mesh_LagrangeP2_Point_hpp
...
struct Mesh_LagrangeP2_API Point_traits
{
  enum { nb_nodes       = 1               };
  enum { nb_faces       = 0               };
...
struct Mesh_LagrangeP2_API Point
{
...
#endif // cf3_mesh_LagrangeP2_Point_hpp
