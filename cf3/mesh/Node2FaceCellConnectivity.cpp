...
void Node2FaceCellConnectivity::set_nodes(Geometry& nodes)
{
...
void Node2FaceCellConnectivity::build_connectivity()
{
  ...
  boost_foreach(Component* face_cell_connectivity_comp, m_face_cell_connectivity->components() )
  {
    const FaceCellConnectivity& face_cell_connectivity = face_cell_connectivity_comp->as_type<FaceCellConnectivity>();
