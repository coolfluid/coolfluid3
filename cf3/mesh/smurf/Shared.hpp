...
#ifndef cf3_mesh_smurf_Shared_hpp
#define cf3_mesh_smurf_Shared_hpp
...
protected:
  ...
  enum smurfElement { P1LINE=1,   P1TRIAG=2,  P1QUAD=3,  P1TETRA=4,  P1HEXA=5,
...
#endif // cf3_mesh_smurf_Shared_hpp
