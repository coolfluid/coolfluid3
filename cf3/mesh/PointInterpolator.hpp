...
class Mesh_API PointInterpolator : public common::Component {
public: // functions
  ...
  bool compute_storage(const RealVector& coordinate, SpaceElem& element, std::vector<SpaceElem>& stencil, std::vector<Uint>& points, std::vector<Real>& weights);
...
template <typename VectorT>
bool PointInterpolator::interpolate(const Field& field, const RealVector& coordinate, VectorT& interpolated_value)
{
