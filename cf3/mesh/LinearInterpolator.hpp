...
#ifndef cf3_mesh_LinearInterpolator_hpp
#define cf3_mesh_LinearInterpolator_hpp
...
public: // functions
  /// constructor
  LinearInterpolator( const std::string& name );

  /// Gets the Class name
  static std::string type_name() { return "LinearInterpolator"; }
...
#endif // cf3_mesh_neu_LinearInterpolator_hpp
