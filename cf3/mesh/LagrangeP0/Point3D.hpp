...
#ifndef cf3_mesh_LagrangeP0_Point3D_hpp
#define cf3_mesh_LagrangeP0_Point3D_hpp
...
struct Mesh_LagrangeP0_API Point3D_traits
{
  typedef Point SF;
  enum { dimension      = 3 };
  enum { nb_faces       = 0 };
...
/// @brief 3D Lagrange P0 Point Element type
...
struct Mesh_LagrangeP0_API Point3D : public ElementTypeBase<Point3D,Point3D_traits>
{
...
#endif // cf3_mesh_LagrangeP0_Point3D_hpp
