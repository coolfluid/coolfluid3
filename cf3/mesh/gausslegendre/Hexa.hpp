...
#ifndef cf3_mesh_gausslegendre_Hexa_hpp
#define cf3_mesh_gausslegendre_Hexa_hpp
...
template <Uint P>
struct mesh_gausslegendre_API Hexa_traits
{
  enum { nb_nodes       = P*P*P           };
...
template <Uint P>
struct mesh_gausslegendre_API Hexa : QuadratureBase< Hexa_traits<P> >
{
public:
  typedef typename QuadratureBase< Hexa_traits<P> >::LocalCoordsT  LocalCoordsT;
  typedef typename QuadratureBase< Hexa_traits<P> >::WeightsT       WeightsT;
...
private:
  ...
  {
    typename QuadratureBase< Hexa_traits<P> >::LocalCoordsT roots;
    typename QuadratureBase< Hexa_traits<P> >::WeightsT weights;
...
template <Uint P>
const typename Hexa<P>::WeightsT& Hexa<P>::weights()
{
...
template <Uint P>
const typename Hexa<P>::LocalCoordsT& Hexa<P>::local_coordinates()
{
...
#endif // cf3_mesh_gausslegendre_Hexa_hpp
