...
cf3::common::ComponentBuilder < EigenLSS, common::Component, LibSolver > aEigenLSS_Builder;
...
void EigenLSS::resize ( Uint nb_dofs )
{
...
Uint EigenLSS::size() const
{
  return m_system_matrix.cols();
}

Real& EigenLSS::at(const cf3::Uint row, const cf3::Uint col)
{
  return m_system_matrix.coeffRef(row, col);
}


void EigenLSS::set_zero()
{
...
void EigenLSS::set_dirichlet_bc(const cf3::Uint row, const cf3::Real value, const cf3::Real coeff)
{
...
RealVector& EigenLSS::rhs()
{
  return m_rhs;
}

const RealVector& EigenLSS::solution()
{
  return m_solution;
}
