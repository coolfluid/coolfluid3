...
#ifndef cf3_solver_actions_ProbePoints_hpp
#define cf3_solver_actions_ProbePoints_hpp
...
class ProbePointsPostProcessor;

////////////////////////////////////////////////////////////////////////////////

/// @brief Probe to interpolate field values to given coordinate along a line
///
...
class solver_actions_API ProbePoints : public common::Action {
friend class ProbePointsPostProcessor;
public: // functions

  /// Contructor
  /// @param name of the component
  ProbePoints ( const std::string& name );

  /// Virtual destructor
  virtual ~ProbePoints();

  /// Get the class name
  static std::string type_name () { return "ProbePoints"; }

  virtual void execute();

  /// @brief Create a post processor action to be executed automatically after probing.
  Handle<ProbePointsPostProcessor> create_post_processor(const std::string& name, const std::string& builder);
...
/// @brief ProbePointsPostProcessor class to attach to a probe
///
...
class solver_actions_API ProbePointsPostProcessor : public common::Action {
public:

  /// Contructor
  /// @param name of the component
  ProbePointsPostProcessor ( const std::string& name );

  /// Virtual destructor
  virtual ~ProbePointsPostProcessor() {}

  /// Get the class name
  static std::string type_name () { return "ProbePointsPostProcessor"; }
...
protected:
  ...
  Handle<ProbePoints> m_ProbePoints;
};
