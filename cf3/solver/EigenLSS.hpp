...
#ifndef cf3_solver_EigenLSS_hpp
#define cf3_solver_EigenLSS_hpp
...
/// EigenLSS component class
/// This class stores a linear system for use by proto expressions
/// @author Bart Janssens
class solver_API EigenLSS : public common::Component {
...
public: // functions
  ...
  EigenLSS ( const std::string& name );

  /// Get the class name
  static std::string type_name () { return "EigenLSS"; }
...
void increment_solution(const RealVector& solution, const std::vector<std::string>& field_names, const std::vector<std::string>& var_names, const std::vector<Uint>& var_sizes, mesh::Mesh& solution_mesh);
