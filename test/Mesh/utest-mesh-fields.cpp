...
#define BOOST_TEST_MODULE "Test module for CF::Mesh::Field"
...
BOOST_AUTO_TEST_CASE( CoordinatesFieldCreation )
{
  ...
  BOOST_CHECK_EQUAL( coordinates.var_type() , Field::VECTOR_2D );
  BOOST_CHECK_EQUAL( coordinates.var_type(0) , Field::VECTOR_2D );
  BOOST_CHECK_EQUAL( coordinates.var_type("coordinates") , Field::VECTOR_2D );
...
BOOST_AUTO_TEST_CASE( SolutionFieldCreation )
{
  ...
  Field& solution = *mesh.create_component_ptr<Field>("solution");
  ...
  BOOST_CHECK_EQUAL( solution.var_type() , Field::SCALAR );
  BOOST_CHECK_EQUAL( solution.var_type(0) , Field::SCALAR );
  BOOST_CHECK_EQUAL( solution.var_type(1) , Field::VECTOR_2D );
  BOOST_CHECK_EQUAL( solution.var_type(2) , Field::SCALAR );
  BOOST_CHECK_EQUAL( solution.var_type("rho") , Field::SCALAR );
  BOOST_CHECK_EQUAL( solution.var_type("U") , Field::VECTOR_2D );
  BOOST_CHECK_EQUAL( solution.var_type("p") , Field::SCALAR );
...
BOOST_AUTO_TEST_CASE( FieldOperators )
{
  ...
  Field& solution = *mesh.get_child_ptr("solution")->as_ptr<Field>();
  Field& solution_copy = *mesh.create_component_ptr<Field>("solution_copy");
  names = list_of("rho")("U")("p");
  types = list_of("scalar")("Vector2D")("scalar");
