...
void GraphicalValueTest::test_createFromOption()
{
  ...
  //
  QCOMPARE( GraphicalValue::create_from_option(Handle< Option >()), (GraphicalValue*) nullptr );

  //
  // 2. check bool, should get a GraphicalBool
  //
  option = Handle< OptionT<bool> >(new OptionT<bool>("OptBool", true));
  ...
  //
  option = Handle< OptionT<int> >(new OptionT<int>("OptInt", int(-156754)));
  value = GraphicalValue::create_from_option( option );
  QVERIFY( is_not_null(value) );
  ...
  //
  option = Handle< OptionT<Uint> >(new OptionT<Uint>("OptUint", Uint(42)));
  value = GraphicalValue::create_from_option( option );
  QVERIFY( is_not_null(value) );
  QVERIFY( is_not_null(dynamic_cast<GraphicalInt*>(value) ) );
  delete value;
  ...
  //
  option = Handle< OptionT<Real> >(new OptionT<Real>("OptReal", Real(3.141592)));
  value = GraphicalValue::create_from_option( option );
  QVERIFY( is_not_null(value) );
  ...
  //
  option = Handle< OptionT<std::string> >(new OptionT<std::string>("OptString", std::string()));
  value = GraphicalValue::create_from_option( option );
  QVERIFY( is_not_null(value) );
  ...
  //
  option = Handle< OptionURI >(new OptionURI("OptUri", URI()));
  value = GraphicalValue::create_from_option( option );
  QVERIFY( is_not_null(value) );
...
void GraphicalValueTest::test_createFromOptionArray()
{
  ...
  //
  option = Handle< OptionArrayT<bool> >(new OptionArrayT<bool>("OptBool", std::vector<bool>()));
  value = GraphicalValue::create_from_option( option );
  ...
  //
  option = Handle< OptionArrayT<int> >(new OptionArrayT<int>("OptInt", std::vector<int>()));
  value = GraphicalValue::create_from_option( option );
  ...
  //
  option = Handle< OptionArrayT<Uint> >(new OptionArrayT<Uint>("OptUint", std::vector<Uint>()));
  value = GraphicalValue::create_from_option( option );
  ...
  //
  option = Handle< OptionArrayT<Real> >(new OptionArrayT<Real>("OptReal", std::vector<Real>()));
  value = GraphicalValue::create_from_option( option );
  ...
  //
  option = Handle< OptionArrayT<std::string> >(new OptionArrayT<std::string>("OptString", std::vector<std::string>()));
  value = GraphicalValue::create_from_option( option );
  ...
  //
  option = Handle< OptionArrayT<URI> >(new OptionArrayT<URI>("OptString", std::vector<URI>()));
  value = GraphicalValue::create_from_option( option );
...
void GraphicalValueTest::test_createFromOptionRestrValues()
{
  ...
  // 6. check URI
  //
  option = Handle< OptionURI >(new OptionURI("OptUri", URI("http://www.google.com")));
...
void GraphicalValueTest::test_createFromOptionArrayRestrValues()
{
  ...
  option = Handle< OptionArrayT<bool> >(new OptionArrayT<bool>("OptBool", vectBool));
  option->restricted_list() += false;
  ...
  option = Handle< OptionArrayT<int> >(new OptionArrayT<int>("OptInt", vectInt));
  option->restricted_list() += int(47687876);
  value = GraphicalValue::create_from_option( option );
  QVERIFY( is_not_null(value) );
  QVERIFY( is_not_null(dynamic_cast<GraphicalArrayRestrictedList*>(value) ) );
  ...
  option = Handle< OptionArrayT<Uint> >(new OptionArrayT<Uint>("OptUint", vectUint));
  ...
  option = Handle< OptionArrayT<Real> >(new OptionArrayT<Real>("OptReal", vectReal));
  option->restricted_list() += Real(2.71);
  value = GraphicalValue::create_from_option( option );
  QVERIFY( is_not_null(value) );
  QVERIFY( is_not_null(dynamic_cast<GraphicalArrayRestrictedList*>(value) ) );
  ...
  option = Handle< OptionArrayT<std::string> >(new OptionArrayT<std::string>("OptString", vectString));
  ...
  option = Handle< OptionArrayT<URI> >(new OptionArrayT<URI>("OptUri", vectUri));
