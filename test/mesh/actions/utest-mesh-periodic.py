...
link_periodic_nodes = root.create_component('LinkPeriodicNodes', 'cf3.mesh.actions.LinkPeriodicNodes')
link_periodic_nodes.mesh = mesh
link_periodic_nodes.source_region = mesh.topology.right
link_periodic_nodes.destination_region = mesh.topology.left
link_periodic_nodes.translation_vector = [-1., 0.]
link_periodic_nodes.execute()
...
domain.write_mesh(cf.URI('periodic.msh'))
