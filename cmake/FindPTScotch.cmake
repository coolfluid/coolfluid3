...
option( CF_SKIP_PTSCOTCH "Skip search for PTScotch library" OFF )
  ...
  if(ZLIB_FOUND)
      set( PTSCOTCH_LIBRARIES ${PTSCOTCH_LIBRARIES} ${ZLIB_LIBRARIES} )
  endif()

coolfluid_log_deps_result( PTSCOTCH PTSCOTCH_INCLUDE_DIR PTSCOTCH_LIBRARIES PTSCOTCH_LIB_SCOTCH PTSCOTCH_LIB_PTSCOTCHERR )
