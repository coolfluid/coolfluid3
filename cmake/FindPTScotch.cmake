...
if( NOT CF_SKIP_PTSCOTCH OR NOT CF_HAVE_MPI )
  ...
  set( PTSCOTCH_LIBRARIES ${PTSCOTCH_LIB_PTSCOTCH} ${PTSCOTCH_LIB_PTSCOTCHERR} ${PTSCOTCH_LIB_PTSCOTCHERREXIT} ${PTSCOTCH_LIB_PTSCOTCHPARMETIS}
                          ${PTSCOTCH_LIB_SCOTCH}   ${PTSCOTCH_LIB_SCOTCHERR}   ${PTSCOTCH_LIB_SCOTCHERREXIT}   ${PTSCOTCH_LIB_SCOTCHMETIS})
