...
#ifndef CF_Mesh_LagrangeP0_Point1D_hpp
#define CF_Mesh_LagrangeP0_Point1D_hpp
...
struct Mesh_LagrangeP0_API Point1D
{
public: // typedefs

  typedef boost::shared_ptr<Point1D>       Ptr;
  typedef boost::shared_ptr<Point1D const> ConstPtr;
...
#endif // CF_Mesh_LagrangeP0_Point1D_hpp
