...
#ifndef CF_Mesh_ElementType2_hpp
#define CF_Mesh_ElementType2_hpp
...
/// This class represents the the data related to an ElementType2
/// @author Tiago Quintino
/// @author Willem Deconinck
class Mesh_API ElementType2 : public Common::Component {

public: // typedefs

  typedef boost::shared_ptr< ElementType2 > Ptr;
  typedef boost::shared_ptr< ElementType2 const> ConstPtr;
...
public: // functions
  ...
  ElementType2( const std::string& name = type_name() );

  /// Default destructor
  virtual ~ElementType2();

  static std::string type_name() { return "ElementType2"; }
  ...
  // virtual const ElementType2& face_type(const Uint face) const = 0;
  // 
...
#endif // CF_Mesh_ElementType2_hpp
