...
#ifndef CF_Mesh_ListBufferIterator_hpp
#define CF_Mesh_ListBufferIterator_hpp
...
private:
  ...
  void increment()
  {
    // cf_assert(m_position != m_buffer.total_allocated());
    ++m_position;
  }
...
#endif // CF_Mesh_ListBufferIterator_hpp
