...
#ifndef CF_Mesh_SF_Tetra_hpp
#define CF_Mesh_SF_Tetra_hpp
...
/// representation of the solution and/or the geometry in a P1 (Tetraar)
/// Tetra element.
/// @author Willem Deconinck
/// @author Tiago Quintino
/// @author Bart Janssens
template <typename SF>
struct Tetra : public Mesh::ElementType {
public:
  
  typedef boost::shared_ptr< Tetra > Ptr;
  typedef boost::shared_ptr< Tetra const> ConstPtr;
  
  Tetra(const std::string& name = type_name()) : Mesh::ElementType(name)
  {
    m_shape = shape;
