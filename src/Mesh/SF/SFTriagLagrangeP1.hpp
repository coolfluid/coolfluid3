...
#ifndef CF_Mesh_SF_SFTriagLagrangeP1_hpp
#define CF_Mesh_SF_SFTriagLagrangeP1_hpp
...
/// @endverbatim
class MESH_SF_API SFTriagLagrangeP1  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFTriagLagrangeP1(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFTriagLagrangeP1"; }
...
#endif // CF_Mesh_SF_SFTriagLagrangeP1
