...
void SFTriagLagrangeP3::value(const MappedCoordsT& mapped_coord, ValueT& result)
{
...
void SFTriagLagrangeP3::gradient(const MappedCoordsT& mapped_coord, GradientT& result)
{
