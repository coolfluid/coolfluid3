...
Common::ComponentBuilder < SFTriagLagrangeP3, ShapeFunction, LibSF > SFTriagLagrangeP3_Builder;

////////////////////////////////////////////////////////////////////////////////

SFTriagLagrangeP3::SFTriagLagrangeP3(const std::string& name) : ShapeFunction(name)
{
...
void SFTriagLagrangeP3::compute_value(const MappedCoordsT& mapped_coord, ValueT& result)
{
...
void SFTriagLagrangeP3::compute_gradient(const MappedCoordsT& mapped_coord, GradientT& result)
{
...
SFTriagLagrangeP3::MappedNodesT SFTriagLagrangeP3::s_mapped_sf_nodes =  ( SFTriagLagrangeP3::MappedNodesT() <<
   0.,    0.,
   1.,    0.,
   0.,    1.,
   1./3., 0.,
