...
#ifndef CF_Mesh_SF_SFHexaLagrangeP1_hpp
#define CF_Mesh_SF_SFHexaLagrangeP1_hpp
...
/// @endverbatim
class MESH_SF_API SFHexaLagrangeP1  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFHexaLagrangeP1(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFHexaLagrangeP1"; }
...
#endif // CF_Mesh_SF_SFHexaLagrangeP1
