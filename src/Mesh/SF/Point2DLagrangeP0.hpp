...
#ifndef CF_Mesh_SF_Point2DLagrangeP0_hpp
#define CF_Mesh_SF_Point2DLagrangeP0_hpp
...
struct MESH_SF_API Point2DLagrangeP0  : public Point<DIM_2D,SFPointLagrangeP0> {

  /// Constructor
  Point2DLagrangeP0(const std::string& name = type_name());

  /// The type name
  static std::string type_name() { return "Point2DLagrangeP0"; }
...
#endif //CF_Mesh_SF_Point2DLagrangeP0
