...
#ifndef CF_Mesh_SF_SFLineLagrangeP0_hpp
#define CF_Mesh_SF_SFLineLagrangeP0_hpp
...
class MESH_SF_API SFLineLagrangeP0  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFLineLagrangeP0(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFLineLagrangeP0"; }
...
#endif // CF_Mesh_SF_SFLineLagrangeP0
