...
void SFLineLagrangeP1::compute_value(const MappedCoordsT& mapped_coord, ValueT& result)
{
...
void SFLineLagrangeP1::compute_gradient(const MappedCoordsT& mappedCoord, GradientT& result)
{
  result(KSI, 0) = -0.5;
  result(KSI, 1) =  0.5;
}
