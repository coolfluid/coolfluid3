...
#ifndef CF_Mesh_SF_SFPointLagrangeP0_hpp
#define CF_Mesh_SF_SFPointLagrangeP0_hpp
...
class MESH_SF_API SFPointLagrangeP0  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFPointLagrangeP0(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFPointLagrangeP0"; }
...
#endif // CF_Mesh_SF_SFPointLagrangeP0
