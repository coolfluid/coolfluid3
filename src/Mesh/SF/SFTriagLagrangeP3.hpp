...
#ifndef CF_Mesh_SF_SFTriagLagrangeP3_hpp
#define CF_Mesh_SF_SFTriagLagrangeP3_hpp
...
/// @endverbatim
class MESH_SF_API SFTriagLagrangeP3  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFTriagLagrangeP3(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFTriagLagrangeP3"; }
...
#endif // CF_Mesh_SF_SFTriagLagrangeP3
