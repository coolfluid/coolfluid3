...
#ifndef CF_Mesh_SF_SFTriagLagrangeP0_hpp
#define CF_Mesh_SF_SFTriagLagrangeP0_hpp
...
/// @endverbatim
class MESH_SF_API SFTriagLagrangeP0  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFTriagLagrangeP0(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFTriagLagrangeP0"; }
...
#endif // CF_Mesh_SF_SFTriagLagrangeP0
