...
#ifndef CF_Mesh_SF_SFQuadLagrangeP3_hpp
#define CF_Mesh_SF_SFQuadLagrangeP3_hpp
...
/// @endverbatim
class MESH_SF_API SFQuadLagrangeP3  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFQuadLagrangeP3(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFQuadLagrangeP3"; }
...
#endif // CF_Mesh_SF_SFQuadLagrangeP3
