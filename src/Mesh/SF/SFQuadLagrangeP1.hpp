...
#ifndef CF_Mesh_SF_SFQuadLagrangeP1_hpp
#define CF_Mesh_SF_SFQuadLagrangeP1_hpp
...
class MESH_SF_API SFQuadLagrangeP1  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFQuadLagrangeP1(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFQuadLagrangeP1"; }
...
#endif // CF_Mesh_SF_SFQuadLagrangeP1
