...
#ifndef CF_Mesh_SF_SFLineLagrangeP2_hpp
#define CF_Mesh_SF_SFLineLagrangeP2_hpp
...
class MESH_SF_API SFLineLagrangeP2  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFLineLagrangeP2(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFLineLagrangeP2"; }
...
#endif // CF_Mesh_SF_SFLineLagrangeP2
