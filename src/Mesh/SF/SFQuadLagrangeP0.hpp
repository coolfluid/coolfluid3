...
#ifndef CF_Mesh_SF_SFQuadLagrangeP0_hpp
#define CF_Mesh_SF_SFQuadLagrangeP0_hpp
...
/// @endverbatim
class MESH_SF_API SFQuadLagrangeP0  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFQuadLagrangeP0(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFQuadLagrangeP0"; }
...
#endif // CF_Mesh_SF_SFQuadLagrangeP0
