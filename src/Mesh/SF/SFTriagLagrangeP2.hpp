...
#ifndef CF_Mesh_SF_SFTriagLagrangeP2_hpp
#define CF_Mesh_SF_SFTriagLagrangeP2_hpp
...
/// @endverbatim
class MESH_SF_API SFTriagLagrangeP2  : public ShapeFunction {
public:
...
public:
  ...
  /// Constructor
  SFTriagLagrangeP2(const std::string& name = type_name());

  /// Type name
  static std::string type_name() { return "SFTriagLagrangeP2"; }
...
#endif // CF_Mesh_SF_SFTriagLagrangeP2
