#ifndef CF_Common_ConnectivityTable_hh
#define CF_Common_ConnectivityTable_hh
...
public: // methods
  ...
  /// Default constructor
  ConnectivityTable() :  m_nbentries(0), m_nbrows(0), m_nbcols(0), m_table(0)
  {
  }
  ...
  ConnectivityTable(const std::valarray<Uint>& columnPattern, T value = T())
  {
    deallocate();
...
#endif // CF_Common_ConnectivityTable_hh
