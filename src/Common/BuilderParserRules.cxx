#include "Common/BuilderParserRules.hh"
                                              ...
                                              const string & rootName)
{
 if(errorType == rootType)
  throw BuilderParserError(FromHere(), "Root and error types must be different.");
  
 if(rootName.empty())
  throw BuilderParserError(FromHere(), "Root name can not be empty.");
