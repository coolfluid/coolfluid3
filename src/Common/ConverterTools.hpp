#ifndef CF_Config_ConverterTools_h
#define CF_Config_ConverterTools_h
...
////////////////////////////////////////////////////////////////////////////////
  ...
  class Common_API ConverterTools
  {
  public:
  ...
  private:
    ...
    /// @param xmlStr XML string to convert.
    /// @return Returns the root node of the built XML tree.
    /// @throws Parser If any error occurs during the string parsing.
...
#endif // CF_Config_ConverterTools_h
