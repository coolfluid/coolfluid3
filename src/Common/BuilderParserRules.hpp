...
#include "Common/BuilderParserMandType.hpp"

typedef std::map<std::string, CF::Common::BuilderParserMandType> BuilderParserFrameAttrs;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  class Common_API BuilderParserRules
  {
  public:
    ...
    /// @throw #BuilderParser If @c errorType and @c rootType are
