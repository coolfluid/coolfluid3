...
#ifndef cf3_common_MPI_Buffer_hpp
#define cf3_common_MPI_Buffer_hpp
...
#define cf3_COMMON_MPI_BUFFER_PACK_OPERATOR(TYPE)\
...
#define cf3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(TYPE)\
...
#define cf3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(TYPE)\
...
#define cf3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(TYPE)\
...
#define cf3_COMMON_MPI_BUFFER_PACK_OPERATOR_SUB_ARRAY(TYPE)\
...
#define cf3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_SUB_ARRAY(TYPE)\
...
#define cf3_COMMON_MPI_BUFFER_PACK_OPERATOR_CONST_SUB_ARRAY(TYPE)\
...
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(bool);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(char);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(unsigned char);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(short);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(unsigned short);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(int);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(unsigned int);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(long);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(unsigned long);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(long long);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(unsigned long long);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(float);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(double);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(long double);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR(std::string);

//CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(bool); // Doesn't compile
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(char);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(unsigned char);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(short);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(unsigned short);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(int);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(unsigned int);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(long);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(unsigned long);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(long long);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(unsigned long long);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(float);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(double);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(long double);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR(std::string);

CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_SUB_ARRAY(Uint);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_SUB_ARRAY(int);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_SUB_ARRAY(Real);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_SUB_ARRAY(bool);

CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_CONST_SUB_ARRAY(Uint);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_CONST_SUB_ARRAY(int);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_CONST_SUB_ARRAY(Real);
CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_CONST_SUB_ARRAY(bool);

CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(bool);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(char);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(unsigned char);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(short);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(unsigned short);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(int);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(unsigned int);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(long);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(unsigned long);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(long long);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(unsigned long long);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(float);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(double);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(long double);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR(std::string);

//CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(bool); // Doesn't compile
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(char);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(unsigned char);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(short);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(unsigned short);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(int);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(unsigned int);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(long);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(unsigned long);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(long long);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(unsigned long long);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(float);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(double);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(long double);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_VECTOR(std::string);

CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_SUB_ARRAY(Uint);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_SUB_ARRAY(int);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_SUB_ARRAY(Real);
CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_SUB_ARRAY(bool);

#undef CF3_COMMON_MPI_BUFFER_PACK_OPERATOR
#undef CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR
#undef CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_VECTOR
#undef CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR
#undef CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_SUB_ARRAY
#undef CF3_COMMON_MPI_BUFFER_UNPACK_OPERATOR_SUB_ARRAY
#undef CF3_COMMON_MPI_BUFFER_PACK_OPERATOR_CONST_SUB_ARRAY
...
#endif // CF3_common_MPI_Buffer_hpp
