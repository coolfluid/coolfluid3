#ifndef COOLFluiD_MathTools_CFSliceVector_hh
#define COOLFluiD_MathTools_CFSliceVector_hh
...
#undef SLICEVEC_EQ_OP_CONST
  ...
  /// @param iElem index
  const T& operator[] (CFuint iElem) const
  {
    return *(_start + iElem);
  }
  ...
  friend bool operator== LTGT (const CFSliceVector<T>& v,
          const T& value);
  ...
  friend T mixedProd LTGT (const CFSliceVector<T>& v1,
  		   const CFSliceVector<T>& v2,
  ...
  friend T innerProd LTGT (const CFSliceVector<T>& v1,
  		   const CFSliceVector<T>& v2);
  ...
  friend void crossProd LTGT (const CFSliceVector<T>& v1,
  		       const CFSliceVector<T>& v2,
...
template <class T>
CFuint CFSliceVector<T>::_size = 0;
...
#endif // COOLFluiD_MathTools_CFSliceVector_hh
