...
LSS::stupidclass::stupidclass() {};
static double stupiddouble=3.;
int LSS::stupidclass::stupidmemberfunc(int x) { return ((int)stupiddouble)*x; };
int LSS::stupidclass::stupidfunc2(double y) { return 2; };
