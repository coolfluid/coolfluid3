...
struct CProtoActionDirector::Implementation
{
    ...
    m_component(component)
  {
    ...
    m_component.options().add_option< OptionT<bool> >("propagate_region", "Propagate Region",
                                                         "If true, changes to the region are propagated to the children of this component",
                                                         true)->link_to(&m_propagate_region);
  }
