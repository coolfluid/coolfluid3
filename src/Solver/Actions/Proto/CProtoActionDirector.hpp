...
public:
  ...
  /// Sets the component that will expose any options generated by actions added using add_action.
  /// If this was not called, created proto actions will hold their own options
  void set_option_sink(Component& component);
