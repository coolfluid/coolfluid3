...
#ifndef CF_Solver_Actions_CCriterionMilestoneIteration_hpp
#define CF_Solver_Actions_CCriterionMilestoneIteration_hpp
...
#endif // CF_Solver_Actions_CCriterionMilestoneIteration_hpp
