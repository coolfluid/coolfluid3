#ifndef CF_GUI_Client_ClientKernel_h
#define CF_GUI_Client_ClientKernel_h
...
////////////////////////////////////////////////////////////////////////////////
  ...
  class ClientKernel : public QObject
  {
    ...
    /// @brief Sets a new TreeModel to the the Client.
    ...
    QMap<QModelIndex, TSshInformation> m_commsSshInfo;
...
#endif // CF_GUI_Client_ClientKernel_h
